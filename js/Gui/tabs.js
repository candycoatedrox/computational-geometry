...
const TabNavigationSetup = {
	...
	refFrame(){
		document.querySelectorAll('nav button').forEach(btn => {
			...
			btn.addEventListener('click', () => {
				...
				// init all canvases in the mini-apps (tabApps) of the refFrame big-app; in an asynchronous manner
				InitTabApps.refFrame();
			});
		})	
	}
	// ,
	...
	// 			document.getElementById('tab-' + btn.dataset.tab).classList.add('active');
	//
	// 			// init all canvases in the mini-apps (tabApps) of the basics big-app; in an asynchronous manner
	// 			InitTabApps.basics();
	// 		});
	// 	})
	// }
