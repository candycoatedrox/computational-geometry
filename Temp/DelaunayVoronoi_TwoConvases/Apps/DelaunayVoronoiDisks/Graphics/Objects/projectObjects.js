...
function drawDelaunayCircles(ctx, circles){
	drawCircles(ctx,circles,DELCIRCLECOLOR, DELCIRCLETHICKNESS);
}

function drawDelaunayDisks(ctx, circles, color=DELFACECOLOR) {
