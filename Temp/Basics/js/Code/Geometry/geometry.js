...
const Geometry = (() => {
  ...
  function ccwAngle(A, B, C) {
	  // console.log("In Geometry: ccwAngle: A = " + JSON.stringify(a));
	  // console.log("In Geometry: ccwAngle: A.x = " + JSON.stringify(a.x));
	  // console.log("In Geometry: ccwAngle: A.y = " + JSON.stringify(a.y));
	  // console.log("In Geometry: ccwAngle: B = " + JSON.stringify(b));
	  // console.log("In Geometry: ccwAngle: C = " + JSON.stringify(c));
	  // const res = Math.atan2(b.y - a.y, b.x - a.x);
	  
	  // WORKING
	  const angleBA = Math.atan2(B.y - A.y, B.x - A.x); 
	  ...
	  if (leftTurn(A,B,C)){
		  ...
		  // STUB
		  ccwAngle = angleBC + angleBA; 
	  	
	  } else if (rightTurn(A,B,C))
	  {
	  ...
	  {
		  // collinear: angle is 0 or Pi or 2Pi TODO and clarify
		  // STUB
		  ccwAngle = 0;
	  }

	  
	  // console.log("In Geometry.ccwAngle. ccwAngle = " + JSON.stringify(ccwAngle));
	  return ccwAngle; 
  }
